...
var Doc = /** @class */ (function (_super) {
     ...
     * @return
     */
    function Doc(title, innerText, fill, editable, fontColor) {
        var _this = _super.call(this, title, innerText, fill, editable, fontColor, "Document") || this;
        _this.strokeWidth = 1;
     ...
     */
    Doc.prototype.addPort = function (port) {
    ...
    */
    Doc.prototype.generateView = function () {
        ...
        var object = $(go.Node, "Table", [new go.Binding("location", "loc", go.Point.parse).makeTwoWay(go.Point.stringify), { locationSpot: go.Spot.Center }], $(go.Panel, "Auto", $(go.Shape, "Document", { fill: this.fill, stroke: "#00A9C9", strokeWidth: this.strokeWidth }, new go.Binding("figure", "figure")), $(go.TextBlock, {
